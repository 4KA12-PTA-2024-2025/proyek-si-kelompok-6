...
<body>
    ...
    <header class="products">
        ...
        <button onclick="redirectToLogin()" class="btn btn-outline-secondary text-end" style="border: 3px solid #607274; margin-right: 10px; font-weight: bold; cursor:pointer; padding: 8px 15px; margin-top: 5px; background-color: #607274">
